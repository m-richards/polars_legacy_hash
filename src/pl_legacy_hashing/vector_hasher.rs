...
// use polars_arrow::legacy::kernels::list_bytes_iter::numeric_list_bytes_iter;
// use rayon::prelude::*;
...
use polars::prelude::*;
// use polars::series::implementations::null::NullChunked;
use polars_arrow::array::{Array, BinaryArray, BinaryViewArray};
// use crate::POOL;
...
pub fn integer_vec_hash<T>(ca: &ChunkedArray<T>, random_state: RandomState, buf: &mut Vec<u64>)
where
    T: PolarsIntegerType,
    T::Native: Hash,
{
